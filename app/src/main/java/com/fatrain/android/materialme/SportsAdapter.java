...
class SportsAdapter extends RecyclerView.Adapter<SportsAdapter.ViewHolder> {
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            detailIntent.putExtra("image_resources", currentSport.getImageResources());
            //Animation Activity Transition.
            ActivityOptionsCompat options = ActivityOptionsCompat.makeSceneTransitionAnimation((Activity) mContext, view,
